...
const SVG_WIDTH = 1888;
const SVG_HEIGHT = 904;
    ...
    <section className={css.banner}>
      <div className={css.description}>
        ...
        <p className={css.text}>
          Более подробное описательное предложение о роде и виде занятий для этого. И ниже призыв присоединиться к
          системе, все по шаблону
        </p>
      </div>
      <div className={css.decorative}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="73.5 47.5 1888 904" width={SVG_WIDTH} height={SVG_HEIGHT}>
          <defs>
            <clipPath id="a">
              <rect width={SVG_WIDTH} height={SVG_HEIGHT} x="73.5" y="47.5" />
            </clipPath>
          </defs>
          <g
            fill="none"
