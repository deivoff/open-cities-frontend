...
export const HeatLayer = (L.Layer ? L.Layer : L.Class).extend({
  ...
  _redraw() {
    ...
    let i; let len; let p; let cell; let x; let y; let j; let len2; let
      k;
...
export const heatLayer = (latlngs, options) => {
